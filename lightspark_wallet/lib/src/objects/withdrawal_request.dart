...
final String? withdrawalId;
    ...
    WithdrawalRequest(
        this.id, this.createdAt, this.updatedAt, this.requestedAmount, this.amount, this.bitcoinAddress, this.status, this.typename, this.estimatedAmount, this.amountWithdrawn, this.completedAt, this.withdrawalId, 
    );
