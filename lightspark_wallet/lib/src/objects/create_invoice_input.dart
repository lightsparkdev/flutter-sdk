...
class CreateInvoiceInput {
    ...
    CreateInvoiceInput(
        this.amountMsats, this.memo, this.invoiceType, this.expirySecs, 
    );
...
static CreateInvoiceInput fromJson(Map<String, dynamic> json) {
    return CreateInvoiceInput(
        ...
        (json['create_invoice_input_invoice_type'] != null) ? InvoiceType.values.asNameMap()[json['create_invoice_input_invoice_type']] ?? InvoiceType.FUTURE_VALUE : null,
